...
export function PricingCards() {
  return <section id="planos" className="public-section public-pricing"><div className="public-container">
    <PublicReveal><div className="public-section-heading"><h2>Seu ritmo.<br /><span>Seu plano.</span></h2><p>Escolha o período da assinatura.<br />A BHON é a mesma nos dois planos.</p></div></PublicReveal>
