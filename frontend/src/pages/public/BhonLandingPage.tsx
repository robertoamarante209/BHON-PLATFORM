...
export function BhonLandingPage() {
  ...
  return <PublicShell>
    ...
    <PublicFaq />
    <section className="public-final-cta public-container"><PublicReveal><h2>Mais clareza para gerir.<br /><span>Mais espaço para cuidar.</span></h2><a href="/comece" className="public-button">Começar teste grátis <ArrowUpRight size={20}/></a></PublicReveal></section>
  </PublicShell>;
}
