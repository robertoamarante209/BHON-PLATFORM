...
- O efeito final do logout carrega sua própria revisão e não pode apagar um login iniciado depois; a segunda revisão também serializa as requisições para preservar a ordem real dos cookies.
