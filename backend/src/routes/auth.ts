...
async function createAuthenticatedSession(app: FastifyInstance, reply: any, request: any, user: any, rememberMe = true) {
...
export async function authRoutes(app: FastifyInstance) {
  app.post("/auth/login", {
    ...
    return createAuthenticatedSession(app, reply, request, user, rememberMe);
  });
  ...
  app.post("/auth/google", {
    ...
    return createAuthenticatedSession(app, reply, request, {
      ...userRow,
      tenant,
    }, rememberMe);
  });
